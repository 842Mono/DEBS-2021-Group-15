...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 42: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              polygons_ = new java.util.ArrayList<com.grpc.Polygon>();
              mutable_bitField0_ |= 0x00000001;
            }
            polygons_.add(
                input.readMessage(com.grpc.Polygon.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.grpc.ChallengerProto.internal_static_Challenger_Location_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.grpc.ChallengerProto.internal_static_Challenger_Location_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.grpc.Location.class, com.grpc.Location.Builder.class);
  }
  ...
  private java.util.List<com.grpc.Polygon> polygons_;
  /**
   * <code>repeated .Challenger.Polygon polygons = 5;</code>
   */
  public java.util.List<com.grpc.Polygon> getPolygonsList() {
    return polygons_;
  }
  /**
   * <code>repeated .Challenger.Polygon polygons = 5;</code>
   */
  public java.util.List<? extends com.grpc.PolygonOrBuilder> 
   ...
   * <code>repeated .Challenger.Polygon polygons = 5;</code>
   */
  public com.grpc.Polygon getPolygons(int index) {
    return polygons_.get(index);
  }
  /**
   * <code>repeated .Challenger.Polygon polygons = 5;</code>
   */
  public com.grpc.PolygonOrBuilder getPolygonsOrBuilder(
      int index) {
    return polygons_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.grpc.Location)) {
      return super.equals(obj);
    }
    com.grpc.Location other = (com.grpc.Location) obj;
  ...
  public static com.grpc.Location parseFrom(
  ...
  public static com.grpc.Location parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.grpc.Location parseFrom(
  ...
  public static com.grpc.Location parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.grpc.Location parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static com.grpc.Location parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.grpc.Location prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.grpc.Location.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.grpc.Location getDefaultInstanceForType() {
      return com.grpc.Location.getDefaultInstance();
    }

    @java.lang.Override
    public com.grpc.Location build() {
      com.grpc.Location result = buildPartial();
    ...
    @java.lang.Override
    public com.grpc.Location buildPartial() {
      com.grpc.Location result = new com.grpc.Location(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.grpc.Location) {
        return mergeFrom((com.grpc.Location)other);
      } else {
    ...
    public Builder mergeFrom(com.grpc.Location other) {
      if (other == com.grpc.Location.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.grpc.Location parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.grpc.Location) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensurePolygonsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        polygons_ = new java.util.ArrayList<com.grpc.Polygon>(polygons_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.grpc.Polygon, com.grpc.Polygon.Builder, com.grpc.PolygonOrBuilder> polygonsBuilder_;
    ...
    public Builder setPolygons(
        int index, com.grpc.Polygon value) {
      if (polygonsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setPolygons(
        int index, com.grpc.Polygon.Builder builderForValue) {
      if (polygonsBuilder_ == null) {
        ensurePolygonsIsMutable();
     ...
     * <code>repeated .Challenger.Polygon polygons = 5;</code>
     */
    public Builder addPolygons(com.grpc.Polygon value) {
      if (polygonsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addPolygons(
        com.grpc.Polygon.Builder builderForValue) {
      if (polygonsBuilder_ == null) {
        ensurePolygonsIsMutable();
    ...
    public Builder addAllPolygons(
        java.lang.Iterable<? extends com.grpc.Polygon> values) {
      if (polygonsBuilder_ == null) {
        ensurePolygonsIsMutable();
     ...
     * <code>repeated .Challenger.Polygon polygons = 5;</code>
     */
    public com.grpc.Polygon.Builder getPolygonsBuilder(
        int index) {
     ...
     * <code>repeated .Challenger.Polygon polygons = 5;</code>
     */
    public com.grpc.Polygon.Builder addPolygonsBuilder() {
      return getPolygonsFieldBuilder().addBuilder(
          com.grpc.Polygon.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.Polygon polygons = 5;</code>
     */
    public com.grpc.Polygon.Builder addPolygonsBuilder(
        int index) {
      return getPolygonsFieldBuilder().addBuilder(
          index, com.grpc.Polygon.getDefaultInstance());
    }
    /**
     * <code>repeated .Challenger.Polygon polygons = 5;</code>
     */
    public java.util.List<com.grpc.Polygon.Builder> 
         getPolygonsBuilderList() {
      return getPolygonsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.grpc.Polygon, com.grpc.Polygon.Builder, com.grpc.PolygonOrBuilder> 
        getPolygonsFieldBuilder() {
      if (polygonsBuilder_ == null) {
  ...
  private static final com.grpc.Location DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.grpc.Location();
  }

  public static com.grpc.Location getDefaultInstance() {
