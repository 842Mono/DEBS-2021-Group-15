...
public final class ChallengerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<de.tum.i13.bandency.Benchmark,
      de.tum.i13.bandency.Locations> getGetLocationsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getLocations",
      requestType = de.tum.i13.bandency.Benchmark.class,
      responseType = de.tum.i13.bandency.Locations.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<de.tum.i13.bandency.Benchmark,
      de.tum.i13.bandency.Locations> getGetLocationsMethod() {
    io.grpc.MethodDescriptor<de.tum.i13.bandency.Benchmark, de.tum.i13.bandency.Locations> getGetLocationsMethod;
      ...
      synchronized (ChallengerGrpc.class) {
        if ((getGetLocationsMethod = ChallengerGrpc.getGetLocationsMethod) == null) {
          ChallengerGrpc.getGetLocationsMethod = getGetLocationsMethod = 
              io.grpc.MethodDescriptor.<de.tum.i13.bandency.Benchmark, de.tum.i13.bandency.Locations>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.tum.i13.bandency.Benchmark.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.tum.i13.bandency.Locations.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<de.tum.i13.bandency.Benchmark,
      de.tum.i13.bandency.Ping> getInitializeLatencyMeasuringMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "initializeLatencyMeasuring",
      requestType = de.tum.i13.bandency.Benchmark.class,
      responseType = de.tum.i13.bandency.Ping.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<de.tum.i13.bandency.Benchmark,
      de.tum.i13.bandency.Ping> getInitializeLatencyMeasuringMethod() {
    io.grpc.MethodDescriptor<de.tum.i13.bandency.Benchmark, de.tum.i13.bandency.Ping> getInitializeLatencyMeasuringMethod;
      ...
      synchronized (ChallengerGrpc.class) {
        if ((getInitializeLatencyMeasuringMethod = ChallengerGrpc.getInitializeLatencyMeasuringMethod) == null) {
          ChallengerGrpc.getInitializeLatencyMeasuringMethod = getInitializeLatencyMeasuringMethod = 
              io.grpc.MethodDescriptor.<de.tum.i13.bandency.Benchmark, de.tum.i13.bandency.Ping>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.tum.i13.bandency.Benchmark.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.tum.i13.bandency.Ping.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<de.tum.i13.bandency.Ping,
      de.tum.i13.bandency.Ping> getMeasureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "measure",
      requestType = de.tum.i13.bandency.Ping.class,
      responseType = de.tum.i13.bandency.Ping.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<de.tum.i13.bandency.Ping,
      de.tum.i13.bandency.Ping> getMeasureMethod() {
    io.grpc.MethodDescriptor<de.tum.i13.bandency.Ping, de.tum.i13.bandency.Ping> getMeasureMethod;
    if ((getMeasureMethod = ChallengerGrpc.getMeasureMethod) == null) {
      synchronized (ChallengerGrpc.class) {
        if ((getMeasureMethod = ChallengerGrpc.getMeasureMethod) == null) {
          ChallengerGrpc.getMeasureMethod = getMeasureMethod = 
              io.grpc.MethodDescriptor.<de.tum.i13.bandency.Ping, de.tum.i13.bandency.Ping>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  public static io.grpc.MethodDescriptor<de.tum.i13.bandency.Ping,
      com.google.protobuf.Empty> getEndMeasurementMethod() {
    io.grpc.MethodDescriptor<de.tum.i13.bandency.Ping, com.google.protobuf.Empty> getEndMeasurementMethod;
      ...
      synchronized (ChallengerGrpc.class) {
        if ((getEndMeasurementMethod = ChallengerGrpc.getEndMeasurementMethod) == null) {
          ChallengerGrpc.getEndMeasurementMethod = getEndMeasurementMethod = 
              io.grpc.MethodDescriptor.<de.tum.i13.bandency.Ping, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
  ...
  public static abstract class ChallengerImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getLocations(de.tum.i13.bandency.Benchmark request,
        io.grpc.stub.StreamObserver<de.tum.i13.bandency.Locations> responseObserver) {
     ...
     * </pre>
     */
    public void initializeLatencyMeasuring(de.tum.i13.bandency.Benchmark request,
        io.grpc.stub.StreamObserver<de.tum.i13.bandency.Ping> responseObserver) {
      asyncUnimplementedUnaryCall(getInitializeLatencyMeasuringMethod(), responseObserver);
    }

    /**
     */
    public void measure(de.tum.i13.bandency.Ping request,
        io.grpc.stub.StreamObserver<de.tum.i13.bandency.Ping> responseObserver) {
    ...
    /**
     */
    public void endMeasurement(de.tum.i13.bandency.Ping request,
  ...
  public static final class ChallengerBlockingStub extends io.grpc.stub.AbstractStub<ChallengerBlockingStub> {
     ...
     * </pre>
     */
    public de.tum.i13.bandency.Locations getLocations(de.tum.i13.bandency.Benchmark request) {
      return blockingUnaryCall(
     ...
     * </pre>
     */
    public de.tum.i13.bandency.Ping initializeLatencyMeasuring(de.tum.i13.bandency.Benchmark request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public de.tum.i13.bandency.Ping measure(de.tum.i13.bandency.Ping request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.google.protobuf.Empty endMeasurement(de.tum.i13.bandency.Ping request) {
      return blockingUnaryCall(
  ...
  public static final class ChallengerFutureStub extends io.grpc.stub.AbstractStub<ChallengerFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<de.tum.i13.bandency.Locations> getLocations(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<de.tum.i13.bandency.Ping> initializeLatencyMeasuring(
        de.tum.i13.bandency.Benchmark request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<de.tum.i13.bandency.Ping> measure(
        de.tum.i13.bandency.Ping request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_GET_LOCATIONS:
          serviceImpl.getLocations((de.tum.i13.bandency.Benchmark) request,
              (io.grpc.stub.StreamObserver<de.tum.i13.bandency.Locations>) responseObserver);
          break;
        case METHODID_INITIALIZE_LATENCY_MEASURING:
          serviceImpl.initializeLatencyMeasuring((de.tum.i13.bandency.Benchmark) request,
              (io.grpc.stub.StreamObserver<de.tum.i13.bandency.Ping>) responseObserver);
          break;
        case METHODID_MEASURE:
          serviceImpl.measure((de.tum.i13.bandency.Ping) request,
              (io.grpc.stub.StreamObserver<de.tum.i13.bandency.Ping>) responseObserver);
          break;
        case METHODID_END_MEASUREMENT:
          serviceImpl.endMeasurement((de.tum.i13.bandency.Ping) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
  ...
  private static abstract class ChallengerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return de.tum.i13.bandency.ChallengerProto.getDescriptor();
    }
